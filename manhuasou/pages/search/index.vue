				...
				<block v-for="(row, index) in keywordList" :key="index">
					<navigator>
						<view class="keyword-entry" hover-class="keyword-entry-tap">
							<view class="keyword-text" @tap.stop="doSearch(row.fields.book_name, row.pk)"><rich-text :nodes="row.fields.book_name"></rich-text></view>
...
export default {
	...
	methods: {
		...
		inputChange(event) {
			...
			uni.request({
				url: 'http://192.168.2.100/getKeyword/' + keyword, //仅为示例
				success: res => {
					this.keywordList = [];
